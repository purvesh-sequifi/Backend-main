...
<head>
    ...
    <style>
        ...
        /* Add spacing after the custom navigation */
        #horizon {
            margin-top: 0;
        }
    </style>
...
<div style="margin-bottom: 0;">
    @include('layouts.admin-nav', ['pageTitle' => 'Queue Dashboard'])
</div>
...
<div id="horizon" v-cloak>
    ...
    <div class="container mb-5">
        <div class="d-flex align-items-center py-2 header">
            <router-link to="/" class="logo d-flex align-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" style="width: 28px; height: 28px;">
