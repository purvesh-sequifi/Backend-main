...
@section('title') 
    EOD Report For Employment Package
@endsection
                    ...
                    <table border="1" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%">
                        <tr>
                            ...
                            <td class="customer_detail col_wid">
                                <p class="customer_detail col_wid"><strong>First Name  </strong></p>
                            </td>

                            <td>
                                <p class="customer_detail col_wid"><strong>Email </strong></p>
                            </td>
                          ...
                          <tr>
                            <td>
                              <p class="customer_detail" ><strong> {{isset($vals->id)?$vals->id:'null'}}</strong></p>
                            </td>

                            <td class="product_name">
                            {{isset($vals->first_name)?$vals->first_name:'null'}} {{isset($vals->last_name)?$vals->last_name:'null'}}
                            </td>

                            <td class="product_name">
                                {{isset($vals->email)?$vals->email:'null'}}
                              </td>

                              <td class="product_name">
                                {{isset($vals->mobile_no)?$vals->mobile_no:'null'}}
                              </td>
