...
@section('title') 
    EOD Report For Get M2 Date Mysales
@endsection
                    ...
                    <table border="1" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%">
                         <tr>
                            ...
                            <td class="customer_detail col_wid">
                                <p class="customer_detail col_wid"><strong>Customer Name  </strong></p>
                            </td>
                            {{-- <td>
                                <p class="customer_detail col_wid"><strong>Closer2 Id </strong></p>
                            </td> --}}
                            <td>
                                <p class="customer_detail col_wid"><strong>Customer Email </strong></p>
                            </td>
                            {{-- <td>
                                <p class="customer_detail col_wid"><strong>Setter2 Id </strong></p>
                            </td> --}}
                            <td>
                                <p class="customer_detail col_wid"><strong>Closer Name </strong></p>
                            </td>


                            <td>
                                <p class="customer_detail col_wid"><strong>Closer Email </strong></p>
                            </td>
                          ...
                          @foreach($data as $val)
                            <tr>
                              ...
                              <td class="product_name">
                                {{isset($val->customer_email)?$val->customer_email:'null'}}
                                </td>
                              {{-- <td class="product_name">
