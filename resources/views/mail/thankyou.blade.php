                        ...
                        <td class="col_wid">
                           <div class="main-content">
                                ...
                                @if($status=='Requested Change')
                                    <i class="fa fa-cube  main-content__checkmark" aria-hidden="true" id="checkmark"></i>
                                @endif
                                @if($status=='Declined')
                                    <i class="fa fa-close main-content__checkmark" aria-hidden="true"></i>
                                @endif
                                @if($status=='expire')
                                    <i class="fa fa-empire main-content__checkmark" aria-hidden="true"></i>
                                    <p class="main-content__body" data-lead-id="main-content-body">The date for accepting the offer letter has expired</p>
                                @endif
                                @if($status=='already')
                                    <i class="fa fa-check main-content__checkmark" id="checkmark"></i>
                                    <p class="main-content__body" data-lead-id="main-content-body">Sorry!! you have already updated the status on this offer letter</p>
                                @endif
                                <p class="main-content__body" data-lead-id="main-content-body">we will connect soon.</p>
                            </div>
                        </td>
                    </tr>
                  </table>
