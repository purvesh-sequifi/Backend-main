                                                                ...
                                                                <td>
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            line-height: 24px;">
                                                                                Dear <strong
                                                                                    style="font-weight: 600; color: #424242;">{{ $emailData['first_name'] }}
                                                                                    {{ $emailData['last_name'] }}</strong>,
                                                                            </p>
                                                                            <p
                                                                            ...
                                                                            line-height: 24px;">
                                                                                ...
                                                                                paystub for
                                                                                @if (
                                                                                    $emailData['pay_period_from'] == $emailData['pay_period_to'] &&
                                                                                        $emailData['pay_frequency'] != App\Models\FrequencyType::DAILY_PAY_ID)
                                                                                    one time payment
                                                                                @elseif($emailData['pay_frequency'] == App\Models\FrequencyType::DAILY_PAY_ID)
                                                                                    Daily Payroll
                                                                                @else
                                                                                    <strong
                                                                                        style="font-weight: 600; color: #424242;">
                                                                                        {{ date('m/d/Y', strtotime($emailData['pay_period_from'])) }}
                                                                                        -
                                                                                        {{ date('m/d/Y', strtotime($emailData['pay_period_to'])) }}
                                                                                    </strong>
                                                                                @endif
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div style="padding: 5px 40px;">
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <a href="{{ $emailData['s3filePath'] }}"
                                                                                target="_blank"
                                                                                style="font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';margin-bottom: 0px;color: #4879FE;font-size: 14px;text-decoration: none;">{{ $emailData['s3filePath'] }}</a>
                                                                        </p>
