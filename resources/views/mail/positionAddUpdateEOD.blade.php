...
@section('title') 
    EOD for Position Added and Updated
@endsection
            ...
            <td>
                <div style="padding: 10px 40px;">
                   <table border="1" cellspacing="0" cellpadding="0">
                       <tr>
                            <td class="col_wid">
                                <p class="customer_detail col_wid" style=""><strong>ID </strong></p>
                            </td>
                            <td class="customer_detail col_wid">
                                <p class="customer_detail col_wid" style=""><strong>Position </strong></p>
                            </td>
                            <td>
                                <p class="customer_detail col_wid" style=""><strong>Department </strong></p>
                            </td>
                            <td>
                                <p class="customer_detail col_wid" style=""><strong>Pay Frequency </strong></p>
                            </td>
                            <td>
                                <p class="customer_detail col_wid" style=""><strong>Overrides </strong></p>
                            </td>
                          ...
                          @foreach($datas as $val)
                            ...
                            <tr>
                              <td>
                                <p class="customer_detail" style=""><strong>{{isset($val['id'])?$val['id']:'null'}}</strong></p>
                              </td>
                              <td class="product_name">
                              {{isset($val['position'])?$val['position']:'null'}}
                              </td>
                              <td class="product_name">
                              {{isset($val['Department'])?$val['Department']:'null'}}
                              </td>
                              <td class="product_name">
                                {{isset($val['pay_frequency'])?$val['pay_frequency']:'null'}}
                                </td>
                                <td class="product_name">
                                    {{isset($val['override'])?$val['override']:'null'}}
                                </td>
                            </tr>
