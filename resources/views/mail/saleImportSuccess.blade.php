                                                                ...
                                                                <td>
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            font-weight: 500;
                                                                            line-height: 24px;">
                                                                                We are delighted to inform you that your sales spreadsheet has been successfully imported into our system.
                                                                            </p>
                                                                            ...
                                                                            font-weight: 500;
                                                                            line-height: 24px;">
                                                                                To access the imported sales data, please click on the link provided below</p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="text-align: center;">
                                                                    <div style="margin-top: 5px; margin-bottom: 5px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';padding: 20px 40px">
                                                                        <a target="_blank" style="background: #6078ec;color: #fff; text-decoration: none; border-radius: 5px; width: 100%; font-size: 18px; padding: 13px 70px;" href="{{env('FRONTEND_BASE_URL')}}reports/sales" class="button">Sales Report</a>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                        ...
                                                                        <div style="margin-top: 3px;">
                                                                            <div style="margin-top: 20px;">
                                                                                ...
                                                                                <a href="{{env('FRONTEND_BASE_URL')}}reports/sales" target="_blank"
                                                                                    ...
                                                                                    font-weight: 500;
                                                                                    line-height: 24px; margin-left: 0px;">
                                                                                    {{env('FRONTEND_BASE_URL')}}reports/sales
                                                                                </a>
                                                                                <p
                                                                                    style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';margin-bottom: 0px;color: #616161;
                                                                                    font-size: 14px;
