                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <p
                                                                        style="margin-top: 0px; margin-bottom: 5px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';padding: 5px 20px; color: #333333; font-weight: 400; font-size: 14px; text-align: left; line-height: 24px;">{{$name}} has reached the 180-day threshold and has been terminated as per system policy.</p>

                                                                    <p
                                                                        style="margin-top: 20px; margin-bottom: 0px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';padding: 5px 20px; color: #333333; font-weight: 400; font-size: 14px; text-align: left; line-height: 24px;">Details:</p>
                                                                    <p
                                                                    ...
                                                                    <p
                                                                        style="margin-top: 0px; margin-bottom: 5px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';padding: 0px 20px; color: #333333; font-weight: 400; font-size: 14px; text-align: left; line-height: 24px;">- Termination Date: {{$date}}</p>
                                                                    <p
                                                                        style="margin-top: 30px; margin-bottom: 5px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';padding: 5px 20px; color: #333333; font-weight: 400; font-size: 14px; text-align: left; line-height: 24px;">For assistance, please reach out to the support team.</p>
