                  ...
                  <table border="0" cellspacing="0" cellpadding="0">
                       <tr>
                        ...
                        <div style="padding: 40px 0px;">
                            ...
                            font-size: 18px;font-weight: 500;margin-left: 42px;">Dear Admin,
                            </p>
                        </div>
                        <div class="main-content">
                           ...
                           <div class="main-content">  
                                    <i class="fa fa-empire main-content__checkmark" aria-hidden="true"></i>
                                    <p class="main-content__body" data-lead-id="main-content-body">{{$data->first_name}} {{$data->last_name}}, {{$data->email}} already rejected on this offer letter</p>
                                    <i class="fa fa-check main-content__checkmark" id="checkmark"></i>
                                    <p class="main-content__body" data-lead-id="main-content-body"> Sorry!! your offer letter has rejected. </p>
                            </div>
                        </td>
                    </tr>
                  </table>
