<?php
    $nav = [
        ["title" => "Overview", "view" => "pages/user-profile/overview"],
        ["title" => "Projects", "view" => "pages/user-profile/projects"],
        ["title" => "Campaigns", "view" => "pages/user-profile/campaigns"],
        ["title" => "Documents", "view" => "pages/user-profile/documents"],
        ["title" => "Followers", "view" => "pages/user-profile/followers"],
        ["title" => "Activity", "view" => "pages/user-profile/activity"],
    ];
?>
