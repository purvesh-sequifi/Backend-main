...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('recon_deduction_history_locks', function (Blueprint $table) {
            ...
            $table->tinyInteger('is_mark_paid')->nullable()->nullable();
            $table->tinyInteger('is_next_payroll')->nullable()->nullable();
            $table->tinyInteger('is_stop_payroll')->nullable()->nullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('recon_deduction_history_locks');
    }
};
