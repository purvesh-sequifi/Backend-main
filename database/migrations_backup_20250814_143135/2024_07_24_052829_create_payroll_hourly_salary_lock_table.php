...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('payroll_hourly_salary_lock', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('payroll_id');
            $table->bigInteger('user_id');
            $table->integer('position_id')->nullable();
            $table->date('date')->nullable();
            $table->double('hourly_rate', 8, 2)->default('0')->nullable();
            $table->double('salary', 8, 2)->default('0')->nullable();
    ...
    {
        Schema::dropIfExists('payroll_hourly_salary_lock');
    }
};
