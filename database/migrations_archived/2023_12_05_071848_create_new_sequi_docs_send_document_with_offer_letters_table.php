...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('new_sequi_docs_send_document_with_offer_letters', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('new_sequi_docs_send_document_with_offer_letters');
    }
};
