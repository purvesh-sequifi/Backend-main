...
return new class extends Migration
{
    ...
    {
        // Drop and recreate log table to ensure correct schema
        // (Handles case where old version exists with different columns)
        ...
        try {
            ...
            if ($exitCode === 0) {
                ...
                DB::table('definer_fix_log')->insert([
                    ...
                    'object_name' => '2025_11_10_000000_fix_all_database_definers_permanently',
                    'table_name' => null,
                    'old_definer' => 'various',
