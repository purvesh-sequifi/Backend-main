...
class Theme
{
     ...
     */
    public static function setViewMode(string $value)
    {
    ...
    public static function getView($path, $params = [], $once = false, $createPartialFileInExport = true)
    {
    ...
    public static function getRootView($path, $params = [], $once = false)
    {
    ...
    public static function includeView($path, $params = [], $once = false, $createPartialFileInExport = true)
    {
        if (! file_exists($path)) {
    ...
    public static function getPresetCssFileName($path)
    {
        ...
        if (self::getOption('layout', 'app/general/theme-preset') !== '' && self::getOption('layout', 'app/general/theme-preset') !== 'default') {
            ...
            } elseif (strpos($path, 'style.bundle.css') !== false) {
