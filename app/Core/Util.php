...
class Util
{
    ...
    public static function notice($text, string $state = 'danger', string $icon = 'icons/duotune/art/art006.svg')
    {
        $html = '';
    ...
    public static function info($text, string $state = 'danger', string $icon = 'icons/duotune/general/gen044.svg')
    {
        $html = '';
