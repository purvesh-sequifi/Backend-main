...
class SclearanceManualReportRequest extends Command
{
    use SClearanceTrait;
     ...
     * @var string
     */
    protected $signature = 'sclearancemanualrequestreport:update';
     ...
     * @var string
     */
    protected $description = 'Manual Request Sclerance pending reports';
    ...
    {
        $screening_requests = SClearanceScreeningRequestList::whereNotNull('screening_request_applicant_id')->where('is_report_generated', 0)->where('status', 'Manual Verification Pending')->get();
