...
class BaseController extends Controller
{
    ...
    public function successJsonResponse(string $message, string $apiName = '', string|array|object $data = '', int $status = 200): JsonResponse
    {
        $response = [
            'status' => true,
            'ApiName' => $apiName,
    ...
    public function errorJsonResponse(string $message, string $apiName = '', string|array|object $data = '', int $status = 500): JsonResponse
    {
        $response = [
            'status' => false,
            'ApiName' => $apiName,
