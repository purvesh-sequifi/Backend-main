...
class PayrollAdjustmentDetail extends Model
{
    use HasFactory, SpatieLogsActivity;

    protected $table = 'payroll_adjustment_details';
    ...
    {
        return $this->hasOne(\App\Models\User::class, 'id', 'user_id')->select(['id', 'first_name', 'last_name', 'image', 'worker_type']);
    }
    ...
    {
        return $this->hasOne('App\Models\user', 'id', 'sale_user_id');
    }
