...
class UserSelfGenCommissionAuditHistory extends Model
{
    use HasFactory;

    protected $table = 'user_selfgen_commission_audit_history';
    ...
    {
        return $this->belongsTo(UserSelfGenCommmissionHistory::class, 'source_id');
    }
