...
class ClawbackSettlement extends Model
{
    use HasFactory, SpatieLogsActivity;

    protected $table = 'clawback_settlements';
    ...
    {
        return $this->hasOne(\App\Models\User::class, 'id', 'user_id')->select('id', 'first_name', 'last_name', 'email', 'redline', 'position_id', 'sub_position_id', 'is_manager', 'is_super_admin', 'stop_payroll', 'worker_type', 'terminate', 'dismiss');
    }
    ...
    {
        return $this->hasOne(\App\Models\User::class, 'id', 'sale_user_id')->select('id', 'first_name', 'last_name', 'position_id', 'image', 'sub_position_id', 'terminate', 'dismiss');
    }
