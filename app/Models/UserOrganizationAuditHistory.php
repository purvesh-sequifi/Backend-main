...
class UserOrganizationAuditHistory extends Model
{
    use HasFactory;

    protected $table = 'user_organization_audit_history';
    ...
    {
        return $this->belongsTo(UserOrganizationHistory::class, 'source_id');
    }
