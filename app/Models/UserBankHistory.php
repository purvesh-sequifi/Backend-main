...
class UserBankHistory extends Model
{
    use HasFactory;

    protected $table = 'user_bank_history';
    ...
    public function getOldValue(string $field)
    {
        ...
        if ($value && in_array($field, ['account_no', 'routing_no', 'confirm_account_no']) && function_exists('dataDecrypt')) {
